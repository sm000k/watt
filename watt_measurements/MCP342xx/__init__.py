...
class MCP342x(object):
    ...
    def get_channel(self):
        return [g for g, c in MCP342x._channel_to_config.items() if c == self.config & MCP342x._channel_mask][0] #iteritems() na items()
    ...
    def read(self, scale_factor=None, offset=None, raw=False):
        ...
        # voltage = count * lsb  / MCP342x.config_to_gain(config_used)
