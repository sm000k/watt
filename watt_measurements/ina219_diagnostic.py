...
ina = INA219(1, INA219.INA219_I2C_ADDRESS6)                                #Change I2C address by dialing DIP switch
...
def performance():
    ...
    while sample >0:
        sample -=1
        temp = ina.get_shunt_voltage_mV()
        # print(sample,temp)

    duration_time = time.perf_counter() - t_start
    print("sample/duration=",no_sample/duration_time)
